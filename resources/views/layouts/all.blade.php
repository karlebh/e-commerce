        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <header class="shadow-md mb-10">
                ...
                <div class="flex flex-wrap justify-around p-2">
                    <a href="{{ route('home') }}" class="font-semibold bg-green-300 py-3 px-4 corners">Random Products</a>
                    <a href="{{ route('category.show', 1) }}" class="font-semibold bg-green-300 py-3 px-4">Shoes</a>
                    <a href="{{ route('category.show', 2) }}" class="font-semibold bg-green-300 py-3 px-4">Bags</a>
                    <a href="{{ route('category.show', 3) }}" class="font-semibold bg-green-300 py-3 px-4">Watch</a>
                    <a href="{{ route('category.show', 4) }}" class="font-semibold bg-green-300 py-3 px-4">Tops</a>
                    <a href="{{ route('category.show', 5) }}" class="font-semibold bg-green-300 py-3 px-4">Knickers</a>
                </div>
            </header>
            ...
            <footer class="h-20 w-full text-center mt-7">
