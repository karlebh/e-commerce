<x-all-layout>
	<div class="text-center mb-5">
		<details>
		<summary class="cursor-pointer text-2xl font-bold text-red-500 mb-3">Test Credit Card Informations</summary>
			<div>
			<div class="mb-4">
			...
			<article>
				<p class="text-xl">For more visit <a href="https://www.paystack.com/docs/payments/test-payments">Paystack</a> and <a href="https://www.developer.flutterwave.com/docs/test-cards">Flutterwave</a> </p>
			</article>
		</div>
		</details>
